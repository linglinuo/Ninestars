...
<!--login end-->
  <main id="main">
    ...
    <section id="store" class="portfolio">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-3">
                    <table class="table table-bordered">
                        <tr>
                        <th><button id="product-manager"><h4><a href="商品管理.php">商品管理</h4></button></th>
                        </tr>
                        <tr>
                        <th><button id="member-manager"><h4><a href="會員管理.php">會員管理</h4></button></th>
                        </tr>
                    </table>
                </div>
                <!--右側-->
        ...
        <!--member-modal start-->
        <form id="new-member-modal" name="new-member-modal" action="" method="POST" enctype="multipart/form-data"> 
            <div class="container">
                <!-- Modal -->
                <div class="modal fade bd-example-modal-lg" id="member-modal" role="dialog">
                    <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">新增會員資料</h4>
                        </div>
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <th scope="row">姓名</th>
                                        <td><input type="text" name="m-name" value=""></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">密碼</th>
                                        <td><input type="text" name="m-pwd" value=""></td> 
                                    </tr>
                                    <tr>
                                        <th scope="row">暱稱</th>
                                        <td><input type="text" name="m-nickname" value=""></td> 
                                    </tr>
                                    <tr>
                                        <th scope="row">性別</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th scope="row">許願版</th>
                                        <td><input type="text" name="m-wish" value=""></td>  
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="modal-footer">
                            <input type="button" name="btn btn-default" id="member-save" value="儲存">
                            <input type="button" name="btn btn-default" id="closemodal2" value="關閉">
