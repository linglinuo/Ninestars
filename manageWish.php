            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="col-sm-3">
                <table class="table table-bordered">
                  <tr>
                    <th><button id="product-manager"><h5><a href="manageProduct.php">商品管理</h5></button></th>
                  </tr>
                  <tr>
                    <th><button id="member-manager"><h5><a href="manageMember.php">會員管理</h5></button></th>
                  </tr>
                  <tr>
                    <th>
                ...
                <tr>
                  ...
                  <td  class="pt-3" align="center" valign="middle">
                    <button type="button" id="newProduct" class="btn btn-light">
                      <a href="insertWish.php"><h6 class="pt-2">新增許願<h6>
                    </button>
                  </td>
                  <td class="pt-3" align="center" valign="middle">
                    <button type="button" id="newProduct" class="btn btn-light">
                      <a href="deleteWish.php"><h6 class="pt-2">刪除許願<h6>
                    </button>
                  </td>
                  <td class="pt-3" align="center" valign="middle">
                    <button type="button" id="newProduct" class="btn btn-light">
                      <a href="updateWish.php"><h6 class="pt-2">修改許願<h6>
                    </button>
                  </td>
                </tr>
              </table>
