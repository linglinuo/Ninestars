                ...
                if($_SESSION['Name'] != null)
                {
                  echo "<div class=\"row justify-content-center\">";
                    echo "<div class=\"col-lg-6 col-sm-6 justify-content-center text-center\">";
                      echo "<form id=\"deleteProduct\" name=\"form\" method=\"post\" action=\"deleteProduct_finish.php\">";
                        echo "<img src=\"img/delete.png\">";
                        echo "<h5 class=\"mt-4\">要刪除的商品<label for=\"p-name\" class=\"error\"></label></h5>";
                        echo "<input type=\"text\" class=\"input form-control\" placeholder=\"商品名稱\" name=\"p-name\">";
